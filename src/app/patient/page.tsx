...
export default function PatientDashboard() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-gray-50 to-emerald-50/30 px-6">
      <div className="w-full max-w-lg rounded-2xl border border-gray-100 bg-white p-10 text-center shadow-xl shadow-gray-200/50">
        ...
        <p className="text-sm text-emerald-600">{session.user?.role}</p>
