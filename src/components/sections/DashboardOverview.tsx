    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
        <div>
          ...
          <p style={{ color: "#9ca3af", margin: "4px 0 0", fontSize: 14 }}>{subtitle}</p>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 8, background: "#f0fdfa", border: "1px solid #ccfbf1", borderRadius: 8, padding: "8px 14px" }}>
          ...
          <span style={{ fontSize: 12, color: "#0f766e", fontWeight: 600 }}>{statusLabel}</span>
        </div>
      </div>
      ...
      {hasPerm("view_appointments") && (
        <div>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: "#9ca3af", textTransform: "uppercase", letterSpacing: "0.1em" }}>{previewLabel}</div>
            <button
              ...
              previewApts.map((apt, i) => (
                <div
                  ...
                  style={{
                    ...
                    borderBottom: i < previewApts.length - 1 ? "1px solid #f3f4f6" : "none",
                  }}
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ fontWeight: 600, fontSize: 14, color: "#111827" }}>{currentRole === "patient" ? apt.doctor : apt.patient}</div>
